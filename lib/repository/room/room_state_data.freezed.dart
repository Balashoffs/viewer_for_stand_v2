...
abstract class $RoomStateDataCopyWith<$Res> {
  ...
  @useResult
  $Res call({MqttRoom? lastRoom, MqttRoom? currentRoom, RoomState state});
...
class _$RoomStateDataImpl implements _RoomStateData {
  _$RoomStateDataImpl(
      {this.lastRoom, this.currentRoom, this.state = RoomState.init});
  ...
  @override
  String toString() {
    return 'RoomStateData(lastRoom: $lastRoom, currentRoom: $currentRoom, state: $state)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, lastRoom, currentRoom, state);
